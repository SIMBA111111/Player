...
export const VideoTag: React.FC<IVideoTag> = ({hls, duration, videoRef}) => {
    ...
    return (
        <div id="playerContainer" className={isVisibleTools ? styles.playerContainer : styles.playerContainer_hidden} onClick={() => {handlePlayPause(videoRef)}} onMouseMove={() => {handleMouseMove()}} onMouseLeave={() => {handleMouseLeave()}} onMouseOver={()=>{handleMouseOver()}}>
