...
const VIDEODATA = {
  url: 'http://localhost:8080/streams/f93b40d2-8d0c-4d9f-ac36-6e5fc7ad88a8/index.m3u8',
  // duration: 9.333,
  fragments: [],
  isLiveStream: true
...
export default function Home() {
  ...
  return (
    <Player playlistUrl={VIDEODATA.url} duration={VIDEODATA?.duration} fragments={VIDEODATA.fragments} isLiveStream={VIDEODATA.isLiveStream}/>
  );
}
